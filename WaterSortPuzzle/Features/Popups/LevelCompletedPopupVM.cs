...
{
    public partial class LevelCompletedPopupVM : FullscreenPopupBaseVM
    {
        ...
        public LevelCompletedPopupVM(IPopupService popupService) : base(popupService)
        {
            System = new(this);
        }
        ...
        public async Task StartAnimation()
        {
            ...
            var displayInfo = DeviceDisplay.Current.MainDisplayInfo;
            float canvasWidthPx = (float)(DeviceWidth * displayInfo.Density);
            //await System.LaunchFireworks(canvasWidthPx, (float)PageHeight);
            await System.ExplodeConfetti(canvasWidthPx, (float)DeviceHeight);
        }
    }
}
